...
public class RegEx {
  ...
  public static void main(String arg[]) {
    ...
    if (regEx.length()<1) {
      ...
      System.out.println("].");
      try {
    	 //il utilise la parse() qui est privée
        RegExTree ret = parse();
  ...
  /**Fonction permet de prendre le regEx et le tranforme en liste de valeur
   * valeur represente en ASCII 
   **/
  ...
  /**
   * il permet de prendre le caractere donnée et le transforme en hexadecimal
   * @param c
   * @return
   */
  ...
  /**
   * il parcours l'arbre est si l'un des caractere lu est ( || ) 
   * @param trees
   * @return true 
   */
  ...
  /**
   * on va parcourir l'arbre jusu'a trouver la parenthese fermante
   * @param trees
   * @return
   * @throws Exception
   */
